...
@dataclass
class TwoWayEqualSolution(Ways):
    """Static data class to stub a graph with two paths with equal road and total road time that lead to a solution."""
    ...
    _graph.add_edge(1, 3, ROAD_TIME=2, FUEL_TIME=2, BREAK_TIME=2)
